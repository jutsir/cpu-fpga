...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { SEG[7] }]; # CA, IO_L24N_T3_A00_D16_14
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { SEG[6] }]; # CB, IO_25_14
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { SEG[5] }]; # CC, IO_25_15
set_property -dict { PACKAGE_PIN K13   IOSTANDARD LVCMOS33 } [get_ports { SEG[4] }]; # CD, IO_L17P_T2_A26_15
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { SEG[3] }]; # CE, IO_L13P_T2_MRCC_14
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { SEG[2] }]; # CF, IO_L19P_T3_A10_D26_14
set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { SEG[1] }]; # CG, IO_L4P_T0_D04_14
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { SEG[0] }]; # DP (Decimal Point), IO_L19N_T3_A21_VREF_15
